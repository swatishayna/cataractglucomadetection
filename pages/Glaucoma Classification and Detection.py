...
st.subheader('Glaucoma Classification and Detection')
...
def create_pdf_report(image_array, pred_img, grayscale_img, contrast_stretched_img, binary_img, binary_img_eroded, binary_img_dilated, pseudocolored_img, pseudocolored_img2,white_spot_ratio, equivalent_diameter, pseudocolored_saliency,custom_image_path="pages/Labels_Guide.jpg"):
    pdf_buffer = BytesIO()
    ...
    # c.setFont("Helvetica", 12)
    # c.drawString(50, page_height - 160, f"Glaucoma Severity and Classification: {get_cataract_severity(mean_magnitude)}")
...
def main():
    ...
    if object:
        ...
        with col2:
            ...
            button = st.button('Classify and Detect')
            if button:
                with st.spinner("Getting results. Please wait..."):
                    ...
                    binary_pred_img = convert_to_binary(contrast_stretched_img, threshold=225   )
        ...
        if prediction:
            ...
            st.caption("Classification and Detection Input:")
            ...
            if equivalent_diameter > 0:
                ...
                equivalent_diameter = white_spot_ratio * 100  # Assuming a scale factor, adjust as needed
                st.text(f"Ratio: {equivalent_diameter:.2f}")
            ...
            pdf_data = create_pdf_report(image_array, pred_img, grayscale_pred_img, contrast_stretched_img, binary_pred_img_eroded, binary_pred_img, binary_pred_img_dilated, pseudocolored_img, pseudocolored_img2, white_spot_ratio, equivalent_diameter,pseudocolored_saliency,custom_image_path="pages/Labels_Guide.jpg")
